...
namespace WindowsFormsApp4.Classes
{
    class StoredProcedures
    {
        ...
        private string m_ConnectionString = $@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename={Application.StartupPath}\Database1.mdf;Integrated Security=True";

        //WPF_OOP.Properties.Settings.Default.Connection;
